...
tuple<CounterFactVariable,CounterFactVariable,CounterFactVariable,CounterFactVariable>
    ...
    double p_K_GoodLaborInt_S = para.p_K_StatusQuo;
    ...
    CounterFactVariable Value_StatusQuo_GoodLaborInt = CalEconomicVariable(p_K_GoodLaborInt_S,
        Equ0_GoodLaborInt_S.FirmMass,Equ0_GoodLaborInt_S.F_Entry,CapitalDemand_GoodLaborInt_S,
        sim_data_GoodLaborInt_S);
...
tuple<ParaEst,ParaVec,EquStateV,EquStateVmat,EquStateV0,EquStateV0mat,EquState0,double,SimData>
    alias::SolveSimulate_StatusQuo_FEntry_V0(
...
//    ArrayXd VEnd = calVEnd(para_est, para_vec, RevOpt);
    ...
    tuple<EquStateV,EquStateVmat> t_Equ = solveV(para_est,para_vec,VEnd,threadsManagement);
    EquStateV EquV = get<0>(t_Equ);
    EquStateVmat EValmat = get<1>(t_Equ);
