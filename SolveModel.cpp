...
tuple<ArrayXd,ArrayXd,ArrayXd> alias::calEV_ProbStatus_PD(const ParaEst & para_est, const ParaVec & para_vec,
    ...
    ArrayXd log_diff_PD = (RevOpt.RevOpt_Prod + Vprime_P - Vprime_D).log();
    ArrayXd dEVal_PD_sigma(para.N * 2);
    dEVal_PD_sigma.segment(0, para.N) = (log_diff_PD - para_est.F_P_PP) / para_est.sigma_PD;
    dEVal_PD_sigma.segment(para.N, para.N) = (log_diff_PD - para_est.F_P_DP) / para_est.sigma_PD;
