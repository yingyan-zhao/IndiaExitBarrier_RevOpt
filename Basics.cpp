...
ParaVec alias::constructParaFull(const ParaEst & para_est) {
    ...
    para_vec.dist0.segment(1,para.N_phi-2) = dist0_temp.segment(1,para.N_phi-2) - dist0_temp.segment(0,para.N_phi-2);
    ...
    para_vec.tran_phi(all,seqN(1,para.N_phi-2))
            = tran_lnphi_CDF(all,seqN(1,para.N_phi-2)) - tran_lnphi_CDF(all,seqN(0,para.N_phi-2));
